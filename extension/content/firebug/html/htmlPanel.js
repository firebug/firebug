...
function(Firebug, FBTrace, Panel, Obj, Domplate, Locale, AttributeEditor, HTMLLib, HTMLModule,
    HTMLReps, TextDataEditor, TextNodeEditor, Events, SourceLink, Css, Dom, Win, Options, Str, Xml,
    Arr, Persist, Menu, Url, CSSModule, CSSInfoTip, CSSSelectorEditor, BaseEditor, Editor,
    InlineEditor) {
