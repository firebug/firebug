...
Cu.import("resource://fbtrace/orion/source-editor-ui.jsm");

XPCOMUtils.defineLazyServiceGetter(this, "clipboardHelper",
                                   "@mozilla.org/widget/clipboardhelper;1",
                                   "nsIClipboardHelper");

const ORION_SCRIPT = "resource://fbtrace/orion/orion.js";
const ORION_IFRAME = "data:text/html;charset=utf8,<!DOCTYPE html>" +
  "<html style='height:100%' dir='ltr'>" +
  "<head><link rel='stylesheet'" +
  " href='chrome://fbtrace-os/skin/orion-container.css'></head>" +
 ...
 */
const ORION_THEMES = {
  mozilla: ["chrome://fbtrace/skin/orion.css"],
};
