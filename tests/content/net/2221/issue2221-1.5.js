...
function onLoadResponse()
{
    ...
    var postTable = FW.FBL.getElementByClass(netInfoRow, "netInfoPostSourceTable");
    if (FBTest.ok(postTable, "There must be table with posted data."))
    {
        var expectedValue = unescape("param1=%E5%E4%F6%FC%E9\n");
